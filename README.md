...
## OUTPUT:
<img width="809" height="135" alt="image" src="https://github.com/user-attachments/assets/25c81f7c-290b-452a-8c95-0cb8972a46ac" />


## RESULT:
The host took 0.821780 seconds to complete it’s computation, while the GPU outperforms the host and completes the computation in 0.043583 seconds. Therefore, float variables in the GPU will result in the best possible result. Thus, matrix summation using 2D grids and 2D blocks has been performed successfully.
